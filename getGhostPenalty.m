function [ii,jj,vv] = getGhostPenalty(CTs,phi,hT,msh,pa)
...
for e=1:nejc
    ...
    iP = getInterPointOnEdge(eP1,eP2,phi1,phi2); % intersection point
    ...
    hE = max( hT(neighborCTs(eGP(3,edge))),hT(neighborCTs(eGP(4,edge))) ); % max h of 2 h in 2 adjacent triangles
    for i=1:2
       for j=1:2
           % [grad_n phi_i]_e
           jumpGradnPhii = ...
