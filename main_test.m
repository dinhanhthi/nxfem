...
% MODEL
%-------------------------------------------------------------------------
model = model_test;    % choose model. cf. file model_chopp2007.m
...
if savePlot
    ...
    path_test_result = strcat(path_nxfem,'results/model_test/',...
