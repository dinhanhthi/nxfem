...
savePlot = 1; % wanna save plot or not?
    testCase = '17a'; % count the test and used to name the folder
    pathOption = 'findGood';
    moreInfo = 'TesT 17a: find best for chopp06 ([R]restart). After changing to FreeNodes. Giong 17 but bcu3=1e-4'; % write inside file txt
