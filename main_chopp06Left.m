...
savePlot = 1; % wanna save plot or not?
    testCase = '19'; % count the test and used to name the folder
    pathOption = 'findGood';
    moreInfo = 'TesT 19: find best for chopp06 ([R]restart). LEFT BC.'; % write inside file txt
...
useFFmesh = 1; % use mesh generated by freefem++?
    ...
    nSeg = 25;  % mesh settings (only for useFFmesh=0)
