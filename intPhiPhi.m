function phiphi = intPhiPhi(pointA,pointB,ii,jj,v,dim,deg)
...
for k=1:nwt
    ...
    tmp = tmp + wt(k)*shapeFunction(ii)*shapeFunction(jj); % shape function jj, jj in 1:3
end
