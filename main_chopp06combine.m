...
savePlot = 1; % wanna save plot or not?
    testCase = '11'; % count the test and used to name the folder
    pathOption = 'findGood';
    moreInfo = 'TesT 11: find best for chopp06 ([R]restart). After changing to FreeNodes. Like test 10, turn off GP + decrease itol'; % write inside file txt
