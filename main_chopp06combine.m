...
savePlot = 1; % wanna save plot or not?
    testCase = '17b'; % count the test and used to name the folder
    pathOption = 'findGood';
    moreInfo = 'TesT 17b: find best for chopp06 ([R]restart). After changing to FreeNodes. Giong 17 but bcu3=5e-4+GP1e-5'; % write inside file txt
