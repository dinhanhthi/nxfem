function RHS = getLoad(omg1NCTs,omg2NCTs,areaNCTs1,areaNCTs2,...
                    CTs,iPs,areaCTs,typeCTs,nodeCTs,msh,pa,model)
...
% GET COMPONENTS
% =========================================================
FNC1 = getLoadNCTs(omg1NCTs,areaNCTs1,1,msh,pa,model); % NCTs1
FNC2 = getLoadNCTs(omg2NCTs,areaNCTs2,2,msh,pa,model); % NCTs2
[FCT1,FCT2] = getLoadCTs(CTs,iPs,areaCTs,typeCTs,nodeCTs,msh,pa,model); % CTs
