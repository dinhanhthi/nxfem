function [nodeCTs,typeCTs,areaChildCTs,iPs,uNormalsCT,areaCTs]...
...
% ========================================================= 
iPs = getInterPoints(CTs,phi,msh,pa); 


%% ========================================================
% Get area of each part of cut triangles
% ========================================================= 
areaCTs = getAreaTris(CTs,msh); % 1 x nTs
...
% ========================================================= 
uNormalsCT = getUNCT(CTs,typeCTs,phi,iPs,pa);
