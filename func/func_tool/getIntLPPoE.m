function phiphi = getIntLPPoE(pointA,pointB,ii,jj,v,pa,L)
% Find the value of int_pointA^pointB of Phi_iPhi_j
% Note: this file copy from intPhiPhi where there is L for a general cases
% Related: 1st used in getNormL2oGstd
% Input: - intersection points: pointA and pointB (1x2)
%        - ii of Phi_i, jj of Phi_j
%        - 3 vertices v of this triangle: 2 coordinates x 3 vertices
...
for k=1:nwt
    ...
    tmp = tmp + L(k)*wt(k)*shFu(ii)*shFu(jj); % shape function jj, jj in 1:3
end
