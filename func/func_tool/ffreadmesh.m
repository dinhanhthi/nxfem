...
%
%% UPDATE from Anh-Thi Dinh
% - This file downloaded from: https://github.com/samplemaker/freefem_matlab_octave_plot
% - Make p, b, t be like the structures of mesh data from matlab
%       https://fr.mathworks.com/help/pde/ug/mesh-data-pet-triples.html

% function [p,b,t,nv,nbe,nt,labels]=ffreadmesh(filename)
function [points,edges,triangles]=ffreadmesh(filename) % Anh-Thi DINH


%     verbose=1;
    verbose=0; % Anh-Thi DINH
...
%% From Anh-Thi DINH
points = p(1:2,:);
edges = NaN(7,size(b,2));
edges(1:2,:) = b(1:2,:);
edges(5,:) = b(3,:);
triangles = NaN(4,size(t,2));
triangles(1:3,:) = t(1:3,:);
