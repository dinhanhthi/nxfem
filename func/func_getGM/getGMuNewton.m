...
%-------------------------------------------------------------------------
sol.w = wold;
func2.gu = defG.dchange;
func2.fw = @(w) w;
K2 = getPf(msh,pa,tris,CT,sol,func2);
[iwgPP1,jwgPP1,vwgPP1] = getTriplePPNCTs(msh,pa,NCTs1,K2.NC1); % NCTs1
[iwgPP2,jwgPP2,vwgPP2] = getTriplePPNCTs(msh,pa,NCTs2,K2.NC2); % NCTs2
[iwgPPc,jwgPPc,vwgPPc1,vwgPPc2] = getTriplePPCTs(msh,pa,CTs,CT,K2); % CTs
