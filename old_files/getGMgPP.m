function Au = getGMgPP(NCTs1,NCTs2,CTs,phi,uold,nodeCTs,typeCTs,...
...
[iGP,jGP,vGP1,vGP2,vGP3,vGP4]...
    = getTripleGPoG(CTs,iPs,uNormalsCT,msh,pa,cp);
...
%-------------------------------------------------------------------------
[igPP1,jgPP1,vgPP1] = getTriplegPPNCTs(NCTs1,uold.omg1,kk1,msh,pa,1); % NCTs1
[igPP2,jgPP2,vgPP2] = getTriplegPPNCTs(NCTs2,uold.omg2,kk2,msh,pa,1); % NCTs2
[igPPc,jgPPc,vgPPc1,vgPPc2] = getTriplegPPCTs(CTs,iPs,uold.ct1,uold.ct2,...
                                typeCTs,nodeCTs,msh,kk1,kk2,pa,1); % CTs
