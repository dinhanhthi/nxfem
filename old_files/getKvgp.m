function K = getKvgp(tris,CT,vold,wS,msh,pa,cpW,cpV,typeG)
% get all necessary K for global matrix
% case: +int_Omg bet/alp*g'*vold*phi*phi
% This is K for: bet/alp*g'_r(r)*vold where r=wS-bet/(alp*lamSys)*vold
% related file: getGMvAANewton.m
% Input:
