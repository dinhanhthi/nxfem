...
% Find the global stiffness matrix for u
% int_Omg grad*grad + int_Gam + int_Omg kk*g(uold)*phi*phi
% Related file: main_sys_linda, getLfwg
% Status: Checked with getGMgPP old
