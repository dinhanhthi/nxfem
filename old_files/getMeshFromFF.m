...
% UPDATE 8/11/18:
% - edges from this function doesn't look like what we want to see,
%   especially edges(5,:) don't gives the number of boundary!!!!!
% - Alternatives by function ffreadmesh.m
...
notbE = setdiff(1:nlecseg,dE); % idx of not-double edges
