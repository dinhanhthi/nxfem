...
mdl = 4; % 1 for sinha, 2 for barrau with x, 3 for barrau with circle
...
pa.tH = 5; % to find the small support using (20) or (21) in arnold 2008
...
if findCR==1 % wanna  find the convergence rate
    ...
    pa.reguMesh = 0; % use regular mesh or not?
    nSeg = 27; % ONLY FOR nStep=1;
    wannaPlot = 0; % wanna plot or not? (JUST FOR nStep=1)
